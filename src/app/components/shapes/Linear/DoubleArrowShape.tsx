export const drawDoubleArrowShape = (ctx: CanvasRenderingContext2D, x: number, y: number, width: number, height: number, fillColor: string, _imageElement?: HTMLImageElement, _borderType?: 'solid' | 'dashed' | 'dotted', _borderSize?: number, _borderColor?: string) => {
    ctx.save();
